...
var listItems = [],
  ...
  playlist = [
    ...
    {"time":"175","title":"Snowflake - Holiday Funky Blues","img":"http://dl.d*ropbox.com/s/myu3b9qtf74sz3i/snowflake2.jpg","src":"http://dl.dropbox.com/s/kwy27cjasc6yodw/snowflake3.mp3"},
...
function formatTime(seconds) {
  let minutes = Math.floor(seconds / 60);
    ...
    seconds = (seconds >= 10) ? seconds : "0" + seconds;
    return minutes + ":" + seconds;
>>>>>>> 60682efc07b3fb0be4ada77f1c019d79d9147b4d
}